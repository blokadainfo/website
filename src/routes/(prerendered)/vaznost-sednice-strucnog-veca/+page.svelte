<script lang="ts">
	import P0 from '$lib/assets/vaznost-sednice/0.jpeg';
	import P1 from '$lib/assets/vaznost-sednice/1.jpeg';
	import P2 from '$lib/assets/vaznost-sednice/2.jpeg';
	import P3 from '$lib/assets/vaznost-sednice/3.jpeg';
	import P4 from '$lib/assets/vaznost-sednice/4.jpeg';
	import P5 from '$lib/assets/vaznost-sednice/5.jpeg';
	import P6 from '$lib/assets/vaznost-sednice/6.jpeg';
	import P7 from '$lib/assets/vaznost-sednice/7.jpeg';
...
>
	...
	<div class="grid w-full">
		<img src={P1} alt="Slika 1" class="col-start-1 row-start-1 w-full object-cover" />
		<a
			href="/"
	...
	<div class="grid w-full">
		<img src={P2} alt="Slika 2" class="col-start-1 row-start-1 w-full object-cover" />
		<a
	...
	<div class="grid w-full">
		<img src={P3} alt="Slika 3" class="col-start-1 row-start-1 w-full object-cover" />
		<a
	...
	<div class="grid w-full">
		<img src={P4} alt="Slika 4" class="col-start-1 row-start-1 w-full object-cover" />
		<a
			href="/"
			class="col-start-1 row-start-1 self-end bg-gradient-to-t from-black to-transparent pb-1 pr-1 pt-20 text-right text-white"
		>
	...
	<div class="grid w-full">
		<img src={P5} alt="Slika 5" class="col-start-1 row-start-1 w-full object-cover" />
		<a
			href="/"
			class="col-start-1 row-start-1 self-end bg-gradient-to-t from-black to-transparent pb-1 pr-1 pt-20 text-right text-white"
		>
	...
	<div class="grid w-full">
		<img src={P6} alt="Slika 6" class="col-start-1 row-start-1 w-full object-cover" />
		<a
			href="/"
			class="col-start-1 row-start-1 self-end bg-gradient-to-t from-black to-transparent pb-1 pr-1 pt-20 text-right text-white"
		>
	...
	<div class="grid w-full">
		<img src={P7} alt="Slika 7" class="col-start-1 row-start-1 w-full object-cover" />
		<a
			href="/"
			class="col-start-1 row-start-1 self-end bg-gradient-to-t from-black to-transparent pb-1 pr-1 pt-20 text-right text-white"
		>
